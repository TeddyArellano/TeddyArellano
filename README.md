...
- **Agentes Inteligentes e Inteligencia Artificial Aplicada**
- **Análisis de Datos y Visualización**
- **Desarrollo Full Stack (Frontend + Backend)**
- **Soluciones Educativas con Tecnología**
...
|---|---|---|
| 📚 **Polilibro (Android App)** | Aplicación educativa sobre Cálculo universitario, con integración de IA para tutorías personalizadas. | Kotlin, XML, OpenAI API, Git |
| 🧠 **Asistente IA para Empresas** | Sistema de asistencia con procesamiento de lenguaje natural para automatizar tareas. | OpenAI, React, Node.js |
| 🌐 **Plataforma Expo-ESCOM** | Sistema web para gestión de eventos, con control de usuarios y módulos de estadísticas. | React, NodeJS, SQL, Git, Kanban |
...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Assembly-555555?style=for-the-badge&logo=gear&logoColor=white"/>
</p>
